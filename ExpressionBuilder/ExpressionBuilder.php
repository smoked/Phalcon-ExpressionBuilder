...
namespace Phalcon\ExpressionBuilder;

use Phalcon\ExpressionBuilder\Exception\ErrorException;

/**
 * ExpressionBuilder class is responsible to dynamically create SQL query parts from Phalcon\Mvc\Model.
 *
 * Class ExpressionBuilder
 * @package Phalcon\ExpressionBuilder
 */
class ExpressionBuilder extends Expression {
     ...
     *
     * @param string $operator Operator ExpressionBuilder
     */
    ...
    /**
     * Create expression to ExpressionBuilder
     *
